...
<?php include('includes/header.php');?>
    ...
    <div class="container">
        ...
        <h1 class="mt-4 mb-3">Search <small>Hospital</small></h1>

        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="index.php">Home</a>
            </li>
            <li class="breadcrumb-item active">Search  Hospital</li>
        </ol>
...
$sql = "SELECT * from hospitaladdress where  (address=:location)";
            ...
            <div class="col-lg-4 col-sm-6 portfolio-item">
                <div class="card h-100">
                    ...
                    <div class="card-block">
                        ...
                        <p class="card-text"><b>Name:</b> <?php echo htmlentities($result->name);?>
                          <p class="card-text"><b>address:</b> <?php echo htmlentities($result->address);?>
                        <p class="card-text"><b>Hotline:</b> <?php echo htmlentities($result->hotline);?>
